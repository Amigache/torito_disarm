...
#include "./c_library_v1-master/common/mavlink_msg_distance_sensor.h"
...
const uint16_t mav_rates[] = {0x00,0x00,0x00};
        ...
        case MAVLINK_MSG_ID_HEARTBEAT:  // #0: Heartbeat
          {
            ...
            if(msg.sysid == AIRCRAFT_SYSTEM_ID) {
              ...
              Serial.print(cond_mode);
              Serial.print(" alt: ");
              Serial.print(distance_sensor.current_distance);
          ...
          case  MAVLINK_MSG_ID_DISTANCE_SENSOR: // #132
          {
              ...
              cond_alt = (distance_sensor.current_distance <= COND_ALTITUDE)?1:0;
              Serial.println("OK");
          }
          break;
...
void request_distance_sensor(){
    ...
    c.target_system = AIRCRAFT_SYSTEM_ID;
    c.target_component = AIRCRAFT_COMPONENT_ID;
    ...
    mavlink_msg_command_long_encode(ARDUINO_SYSTEM_ID, ARDUINO_COMPONENT_ID, &msg, &c);
